...
//************************WW2 PARA*******************************
	class TWC_Backpack_WW2Para_Base: fow_b_uk_bergenpack
	{
		scope = 1;
		maximumLoad = 200;
	};
	...
	class TWC_Backpack_WW2Para_PlatoonCommand: fow_b_us_radio
	{
		scope = 1;
		mass = 29.7;
		maximumLoad = 400;
	...
	class TWC_Backpack_WW2Para_SL: TWC_Backpack_WW2Para_Base
	{
		scope = 1;
		class TransportMagazines
		{
	...
	class TWC_Backpack_WW2Para_Sergeant:TWC_Backpack_WW2Para_Base
	{
		scope = 1;
		class TransportMagazines
		{
	...
	class TWC_Backpack_WW2Para_2IC: TWC_Backpack_WW2Para_Base
	{
		scope = 1;
		class TransportMagazines
		{
	...
	class TWC_Backpack_WW2Para_MGASS: TWC_Backpack_WW2Para_Base
	{
		scope = 1;
		class TransportMagazines
		{
